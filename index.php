...
<div class="wrapper">
  ...
  <div class="facebook-page">
    <div class="">
      <center><h1>Descargar videos de Facebook Online</h1></center>
      <section id="main" style="">
       ...
       <center>
          ...
          <div class=" col-md-8 col-xs-12 vidoesdescargar"  >
            ...
            <form  >
              ...
              <div class="input-group" style="width: 100%;margin-top: 40px;">
                <input type="text" style="border:#7ED214 solid 4px;height:53px;" id="link" class="descargarimput form-control descargarimputxs input-lg" placeholder="Pegue aqui el enlace  a un video" autofocus>
        ...
        <span style="color:#999999;">Al utilizar nuestro servicio, acepta nuestros <a href="terms.php"> Términos de servicio </a> y nuestra <a href="privacy-policy.php"> Política de privacidad </a></span>
      </center>
   ...
   <section class="feature-2-col feature-2-col--first">
    <div class="col-left">
      <div class="text-box">
        <p>Si quieres saber cómo descargar videos de Facebook sin salirte de la web, ¡sólo tienes que instalar “Descargar videos de facebook Helper! Es una extensión gratuita del navegador que te ayuda a bajar los vídeos que quieras sin tener que moverte de la web en la que estás. </p>
        <p>Esta extensión del navegador añade funciones adicionales como la descarga de botones para vídeos de Facebook, con estos botones podrás descargarte los videos de Facebook más fácilmente incluso mientras los ves.</p>
      </div>
 ...
 <h2 class="logo-heading">¿Cómo descargar videos de Facebook?</h2>

 <section class="feature-2-col">
  <div class="col-left">
    <div class="img-box">
      <img style="width: 100%" src="images/descargar videos de facebook portada.jpg" alt="¿Cómo descargar videos de Facebook?">
    </div>
  </div>
  <div class="col-right">
    <div class="text-box">
...
<section class="b-instruction">
  <div class="b-heading">
    <h2>Descargar videos de Facebook online desde la web de Descargar videos de facebook.</h2>

    <p>Cómo descargar un video de Facebook al ordenador a través de la página web de Descargar videos de facebook, tienes que seguir estos tres sencillos pasos:</p>
  </div>
  ...
  <div class="b-instruction-row">
    <div class="b-instruction-col">
      <figure>
        ...
        <figcaption>
          <p class="opacity-1">
            <b>1. Copiar la URL del vídeo</b>
          </p>
          <p>Copia la URL del Facebook vídeo desde la barra de direcciones del navegador al portapapeles, o haz clic con el botón derecho del ratón sobre el vídeo y selecciónalo en el menú contextual. A continuación, "Copiar la URL". </p>
        </figcaption>
      </figure>
    </div>
    <div class="b-instruction-col">
